...
cursor.execute("REATE TABLE ads(id integer not null primary key, title text, description text, price integer, bids integer, create_date text, image_url text, user_id text, category_id text)")
